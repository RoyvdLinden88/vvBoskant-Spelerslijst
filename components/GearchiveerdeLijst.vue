<template>
  <div v-if="archivedPlayers.length > 0" class="card shadow-md border-t-4" style="background: white; border-top-color: #9ca3af;">
...
const { archivedPlayers, getFullName, initials } = usePlayers()
</script>

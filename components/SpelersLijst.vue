      ...
      <ul v-else class="divide-y divide-base-200">
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-extrabold text-white shrink-0" style="background-color: #1a3a6b;">
              {{ initials(player) }}
            </div>
...
const { loading, activePlayers, getFullName, initials } = usePlayers()
</script>
